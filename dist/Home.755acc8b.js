...
parcelRequire = (function(modules, cache, entry, globalName) {
...
})(
  {
      ...
      function(require, module, exports) {
        ...
        function setFakeBody(body) {
          ...
          if (body.fake) {
            ...
            body.style.overflow = _docElement.docElement.style.overflow =
              "hidden";
    ...
    "../../../node_modules/tiny-slider/src/helpers/calc.js": [
      function(require, module, exports) {
        ...
        function calc() {
          ...
          body.fake
            ? (0, _resetFakeBody.resetFakeBody)(body, docOverflow)
            : div.remove();
          return result;
        }
      },
    ...
    "../../../node_modules/tiny-slider/src/helpers/addCSSRule.js": [
      ...
      { "./raf.js": "../../../node_modules/tiny-slider/src/helpers/raf.js" }
    ],
    ...
    "../../../node_modules/tiny-slider/src/helpers/hasClass.js": [
      function(require, module, exports) {
        ...
        var hasClass = _classListSupport.classListSupport
          ? function(el, str) {
    ...
    "../../../node_modules/tiny-slider/src/helpers/addClass.js": [
      function(require, module, exports) {
        ...
        var addClass = _hasClass.classListSupport
          ? function(el, str) {
    ...
    "../../../node_modules/tiny-slider/src/helpers/removeClass.js": [
      function(require, module, exports) {
        ...
        var removeClass = _hasClass.classListSupport
          ? function(el, str) {
              if ((0, _hasClass.hasClass)(el, str)) {
    ...
    "../../../node_modules/tiny-slider/src/helpers/setAttrs.js": [
      function(require, module, exports) {
        ...
        function setAttrs(els, attrs) {
          els =
            (0, _isNodeList.isNodeList)(els) || els instanceof Array
              ? els
              : [els];
    ...
    "../../../node_modules/tiny-slider/src/tiny-slider.js": [
        ...
        var tns = function tns(options) {
          ...
          var CALC = tnsStorage["tC"]
            ...
            PERCENTAGELAYOUT = tnsStorage["tPL"]
              ? (0, _checkStorageValue.checkStorageValue)(tnsStorage["tPL"])
              : (0, _setLocalStorage.setLocalStorage)(
                  tnsStorage,
                  "tPL",
                  (0, _percentageLayout.percentageLayout)(),
                  localStorageAccess
                ),
            CSSMQ = tnsStorage["tMQ"]
              ? (0, _checkStorageValue.checkStorageValue)(tnsStorage["tMQ"])
              : (0, _setLocalStorage.setLocalStorage)(
                  tnsStorage,
                  "tMQ",
                  (0, _mediaquerySupport.mediaquerySupport)(),
                  localStorageAccess
                ),
            TRANSFORM = tnsStorage["tTf"]
              ? (0, _checkStorageValue.checkStorageValue)(tnsStorage["tTf"])
              : (0, _setLocalStorage.setLocalStorage)(
                  tnsStorage,
                  "tTf",
                  (0, _whichProperty.whichProperty)("transform"),
                  localStorageAccess
                ),
            HAS3DTRANSFORMS = tnsStorage["t3D"]
              ? (0, _checkStorageValue.checkStorageValue)(tnsStorage["t3D"])
              : (0, _setLocalStorage.setLocalStorage)(
                  tnsStorage,
                  "t3D",
                  (0, _has3DTransforms.has3DTransforms)(TRANSFORM),
                  localStorageAccess
                ),
            TRANSITIONDURATION = tnsStorage["tTDu"]
              ? (0, _checkStorageValue.checkStorageValue)(tnsStorage["tTDu"])
              : (0, _setLocalStorage.setLocalStorage)(
                  tnsStorage,
                  "tTDu",
                  (0, _whichProperty.whichProperty)("transitionDuration"),
                  localStorageAccess
                ),
            TRANSITIONDELAY = tnsStorage["tTDe"]
              ? (0, _checkStorageValue.checkStorageValue)(tnsStorage["tTDe"])
              : (0, _setLocalStorage.setLocalStorage)(
                  tnsStorage,
                  "tTDe",
                  (0, _whichProperty.whichProperty)("transitionDelay"),
                  localStorageAccess
                ),
            ANIMATIONDURATION = tnsStorage["tADu"]
              ? (0, _checkStorageValue.checkStorageValue)(tnsStorage["tADu"])
              : (0, _setLocalStorage.setLocalStorage)(
                  tnsStorage,
                  "tADu",
                  (0, _whichProperty.whichProperty)("animationDuration"),
                  localStorageAccess
                ),
            ANIMATIONDELAY = tnsStorage["tADe"]
              ? (0, _checkStorageValue.checkStorageValue)(tnsStorage["tADe"])
              : (0, _setLocalStorage.setLocalStorage)(
                  tnsStorage,
                  "tADe",
                  (0, _whichProperty.whichProperty)("animationDelay"),
                  localStorageAccess
                ),
            TRANSITIONEND = tnsStorage["tTE"]
              ? (0, _checkStorageValue.checkStorageValue)(tnsStorage["tTE"])
              : (0, _setLocalStorage.setLocalStorage)(
                  tnsStorage,
                  "tTE",
                  (0, _getEndProperty.getEndProperty)(
                    TRANSITIONDURATION,
                    "Transition"
                  ),
                  localStorageAccess
            ...
            ANIMATIONEND = tnsStorage["tAE"]
              ? (0, _checkStorageValue.checkStorageValue)(tnsStorage["tAE"])
              : (0, _setLocalStorage.setLocalStorage)(
                  tnsStorage,
                  "tAE",
                  (0, _getEndProperty.getEndProperty)(
          ...
          var autoWidth = options.autoWidth,
            ...
            liveregionCurrent,
            preventScroll =
              options.preventScrollOnTouch === "force" ? true : false; // controls
          ...
          function getStartIndex(ind) {
            ind = ind
              ? Math.max(
                  0,
                  Math.min(loop ? slideCount - 1 : slideCount - items, ind)
                )
              : 0;
          ...
          function initStructure() {
            ...
            if (cloneCount) {
              ...
              for (var j = cloneCount; j--; ) {
                ...
                if (carousel) {
                  var cloneLast = slideItems[slideCount - 1 - num].cloneNode(
                    true
                  );
          ...
          function initSliderTransform() {
            ...
            if (hasOption("autoHeight") || autoWidth || !horizontal) {
              ...
              (0, _raf.raf)(function() {
                imgsLoadedCheck(
                  (0, _arrayFromNodeList.arrayFromNodeList)(imgs),
                  function() {
                    imgsComplete = true;
                  }
                );
          ...
          function initSheet() {
            ...
            if (horizontal) {
              if (PERCENTAGELAYOUT || autoWidth) {
                (0, _addCSSRule.addCSSRule)(
                  sheet,
                  "#" + slideId + " > .tns-item",
                  "font-size:" +
                    win.getComputedStyle(slideItems[0]).fontSize +
                    ";",
                  (0, _getCssRulesLength.getCssRulesLength)(sheet)
                );
                (0, _addCSSRule.addCSSRule)(
                  sheet,
                  "#" + slideId,
            ...
            if (responsive && CSSMQ) {
              for (var bp in responsive) {
                ...
                str =
                  middleWrapperStr + innerWrapperStr + containerStr + slideStr;
          ...
          function initTools() {
            ...
            if (hasNav) {
              ...
              (0, _removeAttrs.removeAttrs)(
                navItems[navCurrentIndex],
                "tabindex"
              );
          ...
          function resizeTasks(e) {
            ...
            if (autoplayResetOnVisibility !== autoplayResetOnVisibilityTem) {
              autoplayResetOnVisibility
                ? (0, _addEvents.addEvents)(doc, visibilityEvent)
                : (0, _removeEvents.removeEvents)(doc, visibilityEvent);
            }
            ...
            if (!disable && !freeze) {
              ...
              if (bpChanged && !CSSMQ) {
                ...
                if (horizontal) {
                  ...
                  (0, _removeCSSRule.removeCSSRule)(
                    sheet,
                    (0, _getCssRulesLength.getCssRulesLength)(sheet) - 1
                  );
                  (0, _addCSSRule.addCSSRule)(
                    sheet,
                    "#" + slideId + " > .tns-item",
          ...
          function disableSlider() {
            ...
            if (loop) {
              for (var j = cloneCount; j--; ) {
                ...
                (0, _hideElement.hideElement)(
                  slideItems[slideCountNew - j - 1]
                );
              }
            } // vertical slider
          ...
          function getImageArray(start, end) {
            ...
            while (start <= end) {
              (0, _forEach.forEach)(
                slideItems[start].querySelectorAll("img"),
                function(img) {
                  imgs.push(img);
                }
              );
            ...
            (0, _forEach.forEach)(slideItems, function(item, i) {
              ...
              if (i >= start && i <= end) {
                if ((0, _hasAttr.hasAttr)(item, "aria-hidden")) {
                  (0, _removeAttrs.removeAttrs)(item, [
                    "aria-hidden",
                    "tabindex"
                  ]);
            ...
            return carousel
              ...
              : function() {
                  ...
                  if (
                    ...
                    !ANIMATIONEND ||
                    !speed ||
                    !(0, _isVisible.isVisible)(container)
                  ) {
                    onTransitionEnd();
                  }
                };
          ...
          function onNavClick(e) {
            ...
            while (
              target !== navContainer &&
              !(0, _hasAttr.hasAttr)(target, "data-nav")
            ) {
              target = target.parentNode;
            }
            ...
            if ((0, _hasAttr.hasAttr)(target, "data-nav")) {
              var navIndex = (navClicked = Number(
                  (0, _getAttr.getAttr)(target, "data-nav")
                )),
                targetIndexBase =
                  fixedWidth || autoWidth
          ...
          function getMoveDirectionExpected() {
            return (
              (0, _getTouchDirection.getTouchDirection)(
                (0, _toDegree.toDegree)(
      ...
      },
      {
        ...
        "./helpers/extend.js":
          "../../../node_modules/tiny-slider/src/helpers/extend.js",
        "./helpers/checkStorageValue.js":
          "../../../node_modules/tiny-slider/src/helpers/checkStorageValue.js",
        "./helpers/setLocalStorage.js":
          "../../../node_modules/tiny-slider/src/helpers/setLocalStorage.js",
        "./helpers/getSlideId.js":
          "../../../node_modules/tiny-slider/src/helpers/getSlideId.js",
        "./helpers/calc.js":
          "../../../node_modules/tiny-slider/src/helpers/calc.js",
        "./helpers/percentageLayout.js":
          "../../../node_modules/tiny-slider/src/helpers/percentageLayout.js",
        "./helpers/mediaquerySupport.js":
          "../../../node_modules/tiny-slider/src/helpers/mediaquerySupport.js",
        "./helpers/createStyleSheet.js":
          "../../../node_modules/tiny-slider/src/helpers/createStyleSheet.js",
        "./helpers/addCSSRule.js":
          "../../../node_modules/tiny-slider/src/helpers/addCSSRule.js",
        "./helpers/removeCSSRule.js":
          "../../../node_modules/tiny-slider/src/helpers/removeCSSRule.js",
        "./helpers/getCssRulesLength.js":
          "../../../node_modules/tiny-slider/src/helpers/getCssRulesLength.js",
        "./helpers/toDegree.js":
          "../../../node_modules/tiny-slider/src/helpers/toDegree.js",
        "./helpers/getTouchDirection.js":
          "../../../node_modules/tiny-slider/src/helpers/getTouchDirection.js",
        "./helpers/forEach.js":
          "../../../node_modules/tiny-slider/src/helpers/forEach.js",
        "./helpers/hasClass.js":
        ...
        "./helpers/setAttrs.js":
          "../../../node_modules/tiny-slider/src/helpers/setAttrs.js",
        "./helpers/removeAttrs.js":
          "../../../node_modules/tiny-slider/src/helpers/removeAttrs.js",
        "./helpers/arrayFromNodeList.js":
          "../../../node_modules/tiny-slider/src/helpers/arrayFromNodeList.js",
        "./helpers/hideElement.js":
          "../../../node_modules/tiny-slider/src/helpers/hideElement.js",
        "./helpers/showElement.js":
          "../../../node_modules/tiny-slider/src/helpers/showElement.js",
        "./helpers/isVisible.js":
          "../../../node_modules/tiny-slider/src/helpers/isVisible.js",
        "./helpers/whichProperty.js":
          "../../../node_modules/tiny-slider/src/helpers/whichProperty.js",
        "./helpers/has3DTransforms.js":
          "../../../node_modules/tiny-slider/src/helpers/has3DTransforms.js",
        "./helpers/getEndProperty.js":
          "../../../node_modules/tiny-slider/src/helpers/getEndProperty.js",
        "./helpers/addEvents.js":
          "../../../node_modules/tiny-slider/src/helpers/addEvents.js",
        "./helpers/removeEvents.js":
          "../../../node_modules/tiny-slider/src/helpers/removeEvents.js",
        "./helpers/events.js":
          "../../../node_modules/tiny-slider/src/helpers/events.js",
        "./helpers/jsTransform.js":
          "../../../node_modules/tiny-slider/src/helpers/jsTransform.js"
      }
    ],
    "../../components/Contact-slider/Contact-slider.js": [
      function(require, module, exports) {
        "use strict";
    ...
    "Home.sass": [
      ...
      {
        "./../../components/Sales-boost/images/footprint.svg": [
          [
            "footprint.ab7f0f43.svg",
            "../../components/Sales-boost/images/footprint.svg"
          ],
          "../../components/Sales-boost/images/footprint.svg"
        ],
    ...
    "Home.js": [
      function(require, module, exports) {
        ...
        var _ContactSlider = require("./../../components/Contact-slider/Contact-slider");
        ...
        document.addEventListener(
          "DOMContentLoaded",
          function() {
            new _smoothScroll.default('a[href*="#"]');
            (0, _Header.header)();
            (0, _ContactSlider.slider)();
          },
          {
            passive: false
          }
      ...
      {
        "../../components/Header/Header": "../../components/Header/Header.js",
        "./../../components/Contact-slider/Contact-slider":
          "../../components/Contact-slider/Contact-slider.js",
        "smooth-scroll":
          "../../../node_modules/smooth-scroll/dist/smooth-scroll.polyfills.min.js",
        "./Home.sass": "Home.sass"
...
//# sourceMappingURL=/Home.755acc8b.js.map
